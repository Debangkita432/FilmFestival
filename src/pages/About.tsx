...
const About: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#5f1515] text-[#f6ecd9] font-body relative overflow-hidden">
      <style>{`
        .heading-bebas {
      ...
      <main className="relative z-10 py-20">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="mb-12 text-center fade-in relative z-10">
            ...
            <p className="text-[#f6ecd9]/85 text-lg max-w-2xl mx-auto mt-3">
              A collaboration between The Forum for Film Studies & Allied Arts and SMART Society.
            </p>
          </div>
          ...
          <section className="zigzag flex items-center justify-center gap-12 mb-24 fade-in relative z-10">
            ...
            <article className="card-vintage film-strip p-8 max-w-2xl">
              <h2 className="text-xl font-heading font-black uppercase mb-3 text-[#f3e3d5]">
                Forum for Film Studies & Allied Arts — Kolkata
              </h2>
              <p className="text-base md:text-lg text-[#f6ecd9]/92 leading-relaxed">
                The Forum for Film Studies and Allied Arts, Kolkata, promotes cinema through festivals,
                screenings, and tributes. Collaborating with embassies and institutions like Instituto Cervantes
                and SRFTI, it showcases international and Indian films and honors filmmakers such as Buddhadeb Dasgupta.
              </p>
            </article>
          </section>
          ...
          <section className="zigzag flex items-center justify-center gap-12 flex-row-reverse fade-in relative z-10">
            ...
            <article className="card-vintage film-strip p-8 max-w-2xl">
              ...
              <p className="text-base md:text-lg text-[#f6ecd9]/92 leading-relaxed">
                SMART Society is a US and Canada-based non-profit society aiming to create a pool of unique ideas
                and thoughts through power-packed talks. It serves as a platform for Makers, Artists, Researchers,
                and Technologists to bring forth their views to the world.
              </p>
            </article>
          </section>
        </div>
