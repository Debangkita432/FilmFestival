          ...
          >
            <div className="film-card rounded-2xl p-8">
              <div className="text-center mb-8">
                <h1 className="text-4xl md:text-5xl heading-bebas font-black uppercase tracking-tight text-[#f3e3d5] mb-4">
                  {isLogin ? "Sign In" : "Create Account"}
                </h1>
                <p className="text-[#f8eadd]/85 text-sm">
                  {isLogin
              ...
              <form onSubmit={handleAuth} className="space-y-6">
                <div>
                  <label className="block text-xs font-heading uppercase tracking-wider text-[#f3e3d5] mb-2">
                    Email Address
                  </label>
                  <div className="relative">
                    <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-[#f3e3d5]/60" />
                    <Input
                      type="email"
                      value={email}
                      ...
                      focus:border-[#f3e3d5] focus:ring-[#f3e3d5]"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    transform -translate-y-1/2 w-4 h-4 text-[#f3e3d5]/60"
                    />
                    <Input
                      ...
                      required
                      className="film-input pl-10 pr-10 bg-transparent border-white/10 text-white placeholder-white/40 focus:border-[#f3e3d5] focus:ring-[#f3e3d5]"
                    />
                    <button
                      type="button"
                      onClick={() => setShowPassword(!showPassword)}
                      className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#f3e3d5]/60 hover:text-[#f3e3d5]"
                    >
                      {showPassword ? (
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#f3e3d5] 
                  text-[#5f1515] font-heading font-bold py-3 
              ...
              <div className="my-6">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-[#5f1515] text-white/60">
                      Or continue with
                    </span>
                  </div>
                </div>
              ...
              <Button
                ...
                disabled={loading}
                variant="outline"
                className="w-full bg-transparent border-white/20 text-white hover:bg-white/5 electric-hover"
              >
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-white/70">
                  ...
                  <button
                    ...
                    className="text-[#f3e3d5] hover:text-white font-semibold transition-colors"
                  >
