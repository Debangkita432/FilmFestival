          ...
          <div className="text-center md:text-left space-y-6">
            ...
            <div className="inline-block">
              <div className="bg-background text-primary px-8 py-4 rounded-lg shadow-2xl">
                <div className="text-accent font-black text-2xl md:text-3xl uppercase tracking-wide">
                  Our Venue
                </div>
                <div className="text-accent font-black text-3xl md:text-4xl uppercase tracking-wider">
                  Nandan
                </div>
              </div>
            </div>
