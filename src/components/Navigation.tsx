...
const Navigation = () => {
  ...
  return (
    <nav
      className={[
        "sticky top-0 z-50 bg-background/90 backdrop-blur border-b-4 border-primary",
    ...
    >
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <Link
            to="/"
            className="flex items-center gap-4 focus:outline-none focus:ring-2 focus:ring-primary/50 rounded-md"
          >
            <img
              src={logo}
            ...
            <div className="flex flex-col">
              <h2 className="text-lg md:text-xl font-sans uppercase leading-tight text-black">
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <LinkItem to="/jury">Jury</LinkItem>

            {/* Contact Us now scrolls properly */}
            <a
              href="#footer"
              className="group relative inline-flex flex-col items-start justify-center font-sans text-base md:text-lg uppercase tracking-wide transition-transform duration-200 text-foreground/90 hover:text-primary hover:-translate-y-0.5"
            >
            ...
            <Link to="/register">
              <ScanButton className="ml-2">Join Festival</ScanButton>
            </Link>

            {user ? (
              <ScanButton onClick={handleLogout}>Logout</ScanButton>
            ) : (
              <Link to="/auth">
                <ScanButton>Sign In</ScanButton>
              </Link>
            )}
          </div>
          ...
          <button
            ...
            className="lg:hidden inline-flex h-10 w-10 items-center justify-center rounded-md border border-white/10 hover:bg-white/5 transition-colors focus:outline-none focus:ring-2 focus:ring-primary/50"
          >
      ...
      <div
        className={[
          "lg:hidden overflow-hidden border-t border-white/10 transition-[max-height] duration-300",
        ...
        <div className="px-4 py-3 space-y-1">
          ...
          <div className="pt-2 flex flex-col gap-2">
            ...
            <a
              href="#footer"
              onClick={() => setOpen(false)}
              className="block rounded-md px-3 py-2 text-base md:text-lg font-sans uppercase tracking-wide text-foreground/90 hover:bg-white/5 hover:text-primary"
            >
              Contact Us
            </a>
