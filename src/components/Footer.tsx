      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-heading font-black uppercase mb-6 tracking-tight text-primary">
              About CFCC
            </h3>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link}>
                  <a
                    href="#"
                    className="hover:text-primary hover:translate-x-2 inline-flex items-center gap-2 transition-all duration-300 text-sm font-body font-bold group"
                  >
